...
<header class="wp-block-group alignfull">
    <!-- wp:group {"align":"full","className":"car-top-bar","layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"center"}} -->
    <div class="wp-block-group alignfull car-top-bar">
        <!-- wp:group {"className":"top-bar-contact-info","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left"}} -->
        <div class="wp-block-group top-bar-contact-info">
            ...
            <div class="wp-block-group contact-item">
                <!-- wp:image {"width":20,"height":20,"sizeSlug":"thumbnail","linkDestination":"none"} -->
                <figure class="wp-block-image size-thumbnail">
                    <img src="<?php echo $icon_location_url; ?>" alt="Location" style="width:20px;height:20px;" />
                </figure>
                <!-- /wp:image -->
                <!-- wp:paragraph {"className":"has-base-color has-text-color"} -->
            ...
            <div class="wp-block-group contact-item">
                <!-- wp:image {"width":20,"height":20,"sizeSlug":"thumbnail","linkDestination":"none"} -->
                <figure class="wp-block-image size-thumbnail">
                    <img src="<?php echo $icon_envelope_url; ?>" alt="Email" style="width:20px;height:20px;" />
                </figure>
                <!-- /wp:image -->
                <!-- wp:paragraph {"className":"has-base-color has-text-color"} -->
            ...
            <div class="wp-block-group contact-item">
                <!-- wp:image {"width":20,"height":20,"sizeSlug":"thumbnail","linkDestination":"none"} -->
                <figure class="wp-block-image size-thumbnail">
                    <img src="<?php echo $icon_phone_url; ?>" alt="Phone" style="width:20px;height:20px;" />
                </figure>
                <!-- /wp:image -->
                <!-- wp:paragraph {"className":"has-base-color has-text-color"} -->
            ...
            <div class="wp-block-group contact-item">
                <!-- wp:image {"width":20,"height":20,"sizeSlug":"thumbnail","linkDestination":"none"} -->
                <figure class="wp-block-image size-thumbnail">
                    <img src="<?php echo $icon_clock_url; ?>" alt="Hours" style="width:20px;height:20px;" />
                </figure>
                <!-- /wp:image -->
                <!-- wp:paragraph {"className":"has-base-color has-text-color"} -->
    ...
    <div class="wp-block-group alignfull">
        ...
        <div class="wp-block-columns are-vertically-aligned-center">
            ...
            <div class="wp-block-column" style="flex-basis:30%">
                <!-- wp:group {"className":"car-container-logo","layout":{"type":"constrained"}} -->
                <div class="wp-block-group car-container-logo">
            ...
            <div class="wp-block-column" style="flex-basis:70%">
                <!-- wp:group {"className":"car-container-menu","layout":{"type":"constrained"}} -->
                <div class="wp-block-group car-container-menu">
                    <!-- wp:navigation {"ref":2602,"textColor":"base","layout":{"type":"flex","justifyContent":"right"}} /-->
                </div>
                <!-- /wp:group -->
            </div>
            <!-- /wp:column -->
